...
public class VectorImplList_DataSource_EventListener_ActorChangeEvent__long_
  implements Vector_EventListener_ActorChangeEvent__long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_EventListener_ActorChangeEvent__long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_EventListener_ActorChangeEvent__long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_EventListener_ActorChangeEvent__long_(context, vector_source);
    }

    public EventListener_ActorChangeEvent_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (EventListener_ActorChangeEvent_) vector_source.get(context).get((int) index);
