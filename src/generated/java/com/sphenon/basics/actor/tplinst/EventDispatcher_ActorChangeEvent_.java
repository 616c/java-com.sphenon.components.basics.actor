    ...
    implements EventListener_ActorChangeEvent_
{
    ...
    public void addListener(CallContext context, EventListener_ActorChangeEvent_ listener) {
    ...
    public void removeListener(CallContext context, EventListener_ActorChangeEvent_ listener) {
    ...
    public void notify(CallContext call_context, ActorChangeEvent event) {
