...
public class VectorReferenceToMember_SessionInfo_long_
    implements ReferenceToMember_SessionInfo_long_ReadOnlyVector_SessionInfo_long__
{
    private ReadOnlyVector_SessionInfo_long_ vector;
    private long                          index;

    public VectorReferenceToMember_SessionInfo_long_ (CallContext context, ReadOnlyVector_SessionInfo_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public SessionInfo get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_SessionInfo_long_)) return false;
        if (((VectorReferenceToMember_SessionInfo_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_SessionInfo_long_) object).index  != this.index ) return false;
        return true;
    }
